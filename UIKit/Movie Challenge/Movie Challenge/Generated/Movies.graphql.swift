...
public final class GetTopMoviesQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Movie: GraphQLSelectionSet {
      ...
      public init(id: Int, title: String, voteAverage: Double, posterPath: String? = nil, releaseDate: String, director: Director) {
        self.init(unsafeResultMap: ["__typename": "Movie", "id": id, "title": title, "voteAverage": voteAverage, "posterPath": posterPath, "releaseDate": releaseDate, "director": director.resultMap])
      }
...
public final class GetMovieQuery: GraphQLQuery {
  ...
  public let operationName: String = "GetMovie"
